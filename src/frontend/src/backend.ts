...
export class Backend implements backendInterface {
    ...
    async addReaction(arg0: GroupId, arg1: MessageId, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getGroupList(): Promise<Array<Group>> {
        if (this.processError) {
            try {
                const result = await this.actor.getGroupList();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLastActive(arg0: UserId): Promise<Time> {
        if (this.processError) {
            try {
                const result = await this.actor.getLastActive(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMessageHistory(arg0: GroupId, arg1: bigint): Promise<Array<Message>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMessageHistory(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async inviteToGroup(arg0: GroupId, arg1: UserId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async isGroupMember(arg0: GroupId): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async sendMessage(arg0: GroupId, arg1: string): Promise<Message> {
        if (this.processError) {
            try {
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        avatarId: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.avatarId)),
