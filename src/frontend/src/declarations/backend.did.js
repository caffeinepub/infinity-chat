...
export const idlService = IDL.Service({
  ...
  'addReaction' : IDL.Func([GroupId, MessageId, IDL.Text], [], []),
  'assignCallerUserRole' : IDL.Func([IDL.Principal, UserRole], [], []),
  'createGroup' : IDL.Func([IDL.Text], [GroupId], []),
  'getCallerUserProfile' : IDL.Func([], [IDL.Opt(UserProfile)], ['query']),
  'getCallerUserRole' : IDL.Func([], [UserRole], ['query']),
  'getGroupList' : IDL.Func([], [IDL.Vec(Group)], ['query']),
  'getGroupMembers' : IDL.Func([GroupId], [IDL.Vec(UserId)], ['query']),
  'getLastActive' : IDL.Func([UserId], [Time], ['query']),
  ...
  'inviteToGroup' : IDL.Func([GroupId, UserId], [], []),
  'isCallerAdmin' : IDL.Func([], [IDL.Bool], ['query']),
  'isGroupMember' : IDL.Func([GroupId], [IDL.Bool], ['query']),
  'leaveGroup' : IDL.Func([GroupId], [], []),
  'saveCallerUserProfile' : IDL.Func([UserProfile], [], []),
  'sendMessage' : IDL.Func([GroupId, IDL.Text], [Message], []),
});
